...
class SentMessageCell extends React.Component {
        ...
        <div className="gx-bubble-block">
          <div className="gx-bubble">
            ...
            <Modal visible={this.state.previewVisible} footer={null} onCancel={() => this.setState({previewVisible : false})} >
                <img alt="example" style={{width: '100%'}} src={process.env.REACT_APP_API_URL+"uploads/chat/" + this.props.conversation.body}/>
            </Modal>
